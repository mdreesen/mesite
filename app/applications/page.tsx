...
const radminFeatures = {
  ...
  language: ['Typescript'],
  deployed: ['Vercel'],
  details: "A Project dedicated to businesses to help them take control of their revenue, customers, and team. They can view customers, invoices, team members, and see their revenue."
};
