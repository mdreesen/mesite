...
export const metadata: Metadata = {
  title: "Applications | Dark | White Raven Web Developer",
...
export default function Page() {
      ...
      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
        <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://www.linwoodbusinesssolutions.com/" target="_blank" className="text-sm/6 font-semibold text-white">
              Website <span aria-hidden="true">→</span>
            </a>
          </div>
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://github.com/mdreesen/perrigo-insurance" target="_blank" className="text-sm/6 font-semibold text-white">
  ...
  const projectThree = (
    <div className="relative max-lg:row-start-3 lg:col-start-2 lg:row-start-2">
      ...
      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)]">
        <div className="px-8 pt-8 sm:px-10 sm:pt-10">
          <p className="mt-2 text-lg font-medium tracking-tight text-white max-lg:text-center">Farm Directory Admin</p>
          <p className="mt-2 max-w-lg text-sm/6 text-white max-lg:text-center">
            Admin dashboard to control The Farm Directory
          </p>
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://admin-farm-directory.vercel.app/" target="_blank" className="text-sm/6 font-semibold text-white">
              Website <span aria-hidden="true">→</span>
            </a>
          </div>
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://github.com/mdreesen/admin-farm-directory" target="_blank" className="text-sm/6 font-semibold text-white">
              Github <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
  ...
  const projectFour = (
    <div className="relative lg:row-span-2">
      <div className="absolute inset-px rounded-lg bg-grey-900 lg:rounded-r-[2rem]"></div>
      <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-r-[calc(2rem+1px)]">
        <div className="px-8 pb-3 pt-8 sm:px-10 sm:pb-0 sm:pt-10">
          ...
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://thefarmdirectory.com/" target="_blank" className="text-sm/6 font-semibold text-white">
              Website <span aria-hidden="true">→</span>
            </a>
          </div>
          <div className="mt-10 flex items-center gap-x-6">
            <a href="https://github.com/mdreesen/farm-directory" target="_blank" className="text-sm/6 font-semibold text-white">
              Github <span aria-hidden="true">→</span>
            </a>
          </div>
        </div>
  ...
  return (
    <div className="bg-grey-900 py-24 sm:py-32">
      <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
        <h2 className="text-center text-base/7 font-semibold text-indigo-300">Designing for Impact</h2>
