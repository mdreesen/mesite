...
import { lightscene } from "@/lib/lightscene";

export const metadata: Metadata = {
  title: "Home | Dark | White Raven Web Developer",
  ...
  return (
    <div className="bg-grey-900">
      <div className="relative">
        <div className="mx-auto max-w-7xl">
          <div className="relative z-10 pt-14 lg:w-full lg:max-w-2xl">
            {/* <svg
              ...
              aria-hidden="true"
              className="bg-grey-900 absolute inset-y-0 right-8 hidden h-full w-80 translate-x-1/2 transform lg:block"
            >
              <polygon className="bg-grey-900" points="0,0 90,0 50,100 0,100" />
            </svg> */}
            ...
            <div className="relative px-6 py-32 sm:py-40 lg:px-8 lg:py-56 lg:pr-0">
              <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
                ...
                <div className="mt-10 flex items-center gap-x-6">
                  <Link href="/applications" className="text-sm/6 font-semibold text-white">
        ...
        <div className="bg-grey-900 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
          <Image
            alt="White Raven homepage image of computer monitor and desk"
            width={1000}
            height={1000}
            priority
            src={'/assets/homepageAI.webp'}
